...
public final class GreetingGrpc {
  ...
  public static final String SERVICE_NAME = "greet.Greeting";
  ...
  public static io.grpc.MethodDescriptor<com.proto.greet.GreetRequest,
    ...
    if ((getGreetMethod = GreetingGrpc.getGreetMethod) == null) {
      synchronized (GreetingGrpc.class) {
        if ((getGreetMethod = GreetingGrpc.getGreetMethod) == null) {
          GreetingGrpc.getGreetMethod = getGreetMethod = 
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ...
                  .setSchemaDescriptor(new GreetingMethodDescriptorSupplier("Greet"))
                  .build();
          }
        }
     }
